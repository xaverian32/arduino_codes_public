...
int buttons[9] = {23,21,22,4,14,12,13,26,25};
...
//    if (digitalRead(LT) == LOW) {                     //    taking and sending input from top left trigger
...
//      bleGamepad.sendReport();
//    }
//    if (digitalRead(RT) == LOW) {                     //    taking and sending input from top right trigger
...
////    }
    ...
    int value2 = map(analogRead(LV), 0, 4095, 30000, 0);
